@echo off
REM CrediYa Authentication Service - Deploy Script for Podman (Windows)
REM This script manages deployment operations for the authentication service
...
:start_services
echo Starting CrediYa Authentication Service...
...
echo Service URLs:
echo    • Authentication API: http://localhost:8080
echo    • Health Check: http://localhost:8080/actuator/health
echo    • Swagger UI: http://localhost:8080/swagger-ui.html
goto end

:stop_services
echo Stopping CrediYa Authentication Service...
podman-compose -f %COMPOSE_FILE% down
echo Services stopped successfully
goto end

:restart_services
echo Restarting CrediYa Authentication Service...
call :stop_services
call :start_services
goto end
