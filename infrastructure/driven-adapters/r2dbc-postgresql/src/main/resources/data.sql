...
INSERT INTO roles (name, description) VALUES
    ('APPLICANT', 'Usuario que puede solicitar préstamos personales'),
    ('ADMIN', 'Usuario con permisos administrativos completos del sistema'),
    ('ASESOR', 'Asesor de crédito con permisos de gestión')
